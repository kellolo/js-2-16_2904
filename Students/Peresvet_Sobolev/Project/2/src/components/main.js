 ...
 // PARENT ==> Catalog & Basket // Контейнеры
 // PARENT ==> CatalogItem & BasketItem // Компоненты
 // Компонентный подход: все компоненты (классы) делятся на два типа: 1)Конетйнеры, 2) Компоненты
 // Контейнеры ("Умные компоненты") - содержат в мебе всю компонентную логику
 // Компоненты ("Глупые компоненты") - не содержат логики, но "отдают логику"
 ...
 export default function () {
     ...
     let catalogOne = new catalog(cartOne);
 }